...
<body>
  <div class="main-content">
	...
	<div id="error2" class="errorDiv" >La password inserita non è corretta</div>
        ...
        <div class="col-xl-8 order-xl-1 mb-5 mb-xl-0">
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
			  <center>
				<form method="post" action="/Account/modificaAccount/Laboratorio">
				
					<p class="pt-md-4">
						<input class="form-control" type="text" name="nometitolare" placeholder="Nome Titolare" value="<?= esc(session()->get('nome')) ?>" style="width:90%" required>
					</p>
					
					<p class="pt-md-4">
						<input class="form-control" type="text" name="cognometitolare" placeholder="Cognome Titolare" value="<?= esc(session()->get('cognome')) ?>" style="width:90%" required>
					</p>
					
					<p class="pt-md-4">
						<input class="form-control" type="text" name="codfistitolare" placeholder="Codice Fiscale Titolare" value="<?= esc(session()->get('codicefiscale')) ?>" style="width:90%" required>
					</p>
					
					<p class="pt-md-4">
						<input class="form-control" type="text" name="nome" placeholder="Nome Laboratorio" value="<?= esc(session()->get('nomelab')) ?>" style="width:90%" required>
					</p>
					...
					<p class="pt-md-4">
						<input class="form-control" type="text" name="codicefiscale" placeholder="Codice Fiscale Laboratorio" value="<?= esc(session()->get('cflab')) ?>" style="width:90%" required>
					</p>
