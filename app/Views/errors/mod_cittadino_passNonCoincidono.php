        ...
        <div class="col-xl-8 order-xl-1 mb-5 mb-xl-0">
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
			  <center>
				<form method="post" action="/Account/modificaAccount/Cittadino">
					...
					<p class="pt-md-4" id="mySelect" style="width:90%">
						<select name="medicoCurante" class="form-control" required>
						  <option class="firstOption"><?= esc(session()->get('medico')) ?></option>
						  <option class='otherOptions'>Altro Medico</option>
						  <?php
					...
					<p class="pt-md-4">
						<input class="form-control" type="password" name="nuovaPassword" placeholder="Nuova Password" style="width:90%" required>
					</p>
