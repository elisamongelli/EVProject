...
<body>
	...
	<div class="div-opuscolo">
		...
		<p  class="p-opuscolo" style="margin-top: 2%">Prima di effettuare il tampone è necessario compilare il consenso informato e il questionario di anamnesi.  Per ragioni di validità la compilazione deve 
	...
	<div class="div-opuscolo">
		...
		<p  class="p-opuscolo" style="margin-top: 2%">Esiste la possibilità che, nonostante la negatività del test, sia stata comunque contratta l'infezione da SARS-CoV-2 e che si manifestino sintomi nei giorni seguenti. 
		...
		<p  class="p-opuscolo" style="margin-top: 2%">Se il risultato del test è positivo, la prima cosa da fare è isolarsi dal resto della famiglia, se possibile in una stanza singola ben ventilata, evitare contatti sociali e 
